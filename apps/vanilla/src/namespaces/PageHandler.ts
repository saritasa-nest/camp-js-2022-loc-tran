...
import { ANIME_ROUTE, COUNT_LS, DECIMAL, DEFAULT_FILTERING, DEFAULT_OFFSET, DEFAULT_PAGE, DEFAULT_QUERIES, DEFAULT_SORTING, FILTER_HEADER, FILTER_LS, LIMIT, LIMIT_HEADER, LIMIT_LS, OFFSET_HEADER, OFFSET_LS, PAGE_LS, SORT_HEADER, SORT_LS } from '../script/constants';
